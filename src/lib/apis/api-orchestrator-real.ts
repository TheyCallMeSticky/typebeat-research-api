...
import { createYouTubeClientReal } from './youtube-client-real';
import { createSpotifyClientReal } from './spotify-client-real';
import { createLastFmClientReal } from './lastfm-client-real';
import { createGeniusClientReal } from './genius-client-real';
...
export class APIOrchestrator {
  ...
  constructor() {
    this.youtubeClient = createYouTubeClientReal();
    this.spotifyClient = createSpotifyClientReal();
    this.lastfmClient = createLastFmClientReal();
    this.geniusClient = createGeniusClientReal();
